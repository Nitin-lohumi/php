    ...
    <div class="container">
        <h3>Welcome</h3>
         ...
         <form action="welcome.php" method="POST">
           ...
           <input type="text" placeholder="Enter your name"  name="name" required id="u_name" class="name" autocomplete="off"><br>
           ...
           <input type="date" value="DOB" name="dob" class="dob" required    id="dob"><br>
           

           <label for="phone">Phone : </label><input type="phone" id="phone" class="phn" name="phone" placeholder="Enter your phone" id="phn" required autocomplete="off"><br>
...
<?php
  ...
  if(!$con){  
   ...
   $phone=$_POST['phone'];
   $feedback=$_POST['text'];
//    $sql="INSERT INTO `register_form`.`data_register` (`Name`, `Gender`, `Email`, `DOB`, `Phone`, `feedback`) VALUES ('$name', '$gender' , '$email',current_time(),'$phone','$feedback');";
    $sql="INSERT INTO `register_form`.`data_register` (`name`, `gender`, `Email`, `DOB`, `Phone`, `feedback`) VALUES ('$name', '$gender', '$email', current_time(), '$phone', '$feedback');";
